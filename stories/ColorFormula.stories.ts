...
import { COLOR_FAMILIES, LMAX, LMIN } from "../style-dictionary/actions/web/oklch-formulas.js";

type ColorFormulaArgs = Record<string, never>;

const meta: Meta<ColorFormulaArgs> = {
  title: "Tokens/Color/Formula",
  tags: ["docs"],
};

export default meta;

type Story = StoryObj<ColorFormulaArgs>;
