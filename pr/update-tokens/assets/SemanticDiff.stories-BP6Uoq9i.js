function j(e){return typeof e=="object"&&e!==null&&"$value"in e&&"$type"in e}function C(e){return e.trimStart().startsWith("{")&&e.trimEnd().endsWith("}")}function y(e,r,n){for(const[t,a]of Object.entries(e)){const l=r?`${r}.${t}`:t;j(a)?n.set(l,a):typeof a=="object"&&a!==null&&y(a,l,n)}}function h(e,r,n){for(const[t,a]of Object.entries(e)){const l=r?`${r}.${t}`:t;j(a)||typeof a=="object"&&a!==null&&(n.add(l),h(a,l,n))}}function x(e,r){const n=new Map,t=new Map;y(e,"",n),y(r,"",t);const a=new Set,l=new Set;h(e,"",a),h(r,"",l);const i=[],$=new Set([...n.keys(),...t.keys()]);for(const s of $){const c=n.get(s)??null,d=t.get(s)??null;if(c===null&&d!==null)i.push({path:s,kind:"added",baseline:null,current:d});else if(c!==null&&d===null)i.push({path:s,kind:"removed",baseline:c,current:null});else if(c!==null&&d!==null){if(c.$value===d.$value)continue;const p=C(c.$value),u=C(d.$value);p&&u?i.push({path:s,kind:"changed-alias",baseline:c,current:d}):!p&&!u?i.push({path:s,kind:"changed-value",baseline:c,current:d}):p&&!u?i.push({path:s,kind:"alias-to-value",baseline:c,current:d}):i.push({path:s,kind:"value-to-alias",baseline:c,current:d})}}const g=new Set([...l].filter(s=>!a.has(s))),k=new Set([...a].filter(s=>!l.has(s)));function B(s,c){const d=s.split(".");for(let p=1;p<d.length;p++){const u=d.slice(0,p).join(".");if(c.has(u))return!0}return!1}for(const s of g)B(s,g)||i.push({path:s,kind:"group-added",baseline:null,current:null});for(const s of k)B(s,k)||i.push({path:s,kind:"group-removed",baseline:null,current:null});return i.sort((s,c)=>s.path.localeCompare(c.path))}function L(e,r=2){const n=new Map;for(const t of e){const l=t.path.split(".").slice(0,r).join(".");n.has(l)||n.set(l,[]),n.get(l).push(t)}return n}const o={paper:"#f5f2eb",ink:"#2e2e2b",inkFaint:"#736e65",rule:"#ccc9c1",added:"#d4edda",addedBorder:"#3b8349",removed:"#f8d7da",removedBorder:"#be342d",changed:"#fff3cd",changedBorder:"#c8a020",structural:"#e8e4f8",structuralBorder:"#5a4fcf",chip:"#00000018"},N={added:{label:"Added",badge:`background:${o.addedBorder};color:#fff`,rowBg:o.added,rowBorder:o.addedBorder},removed:{label:"Removed",badge:`background:${o.removedBorder};color:#fff`,rowBg:o.removed,rowBorder:o.removedBorder},"changed-value":{label:"Value changed",badge:`background:${o.changedBorder};color:#fff`,rowBg:o.changed,rowBorder:o.changedBorder},"changed-alias":{label:"Alias retargeted",badge:`background:${o.changedBorder};color:#fff`,rowBg:o.changed,rowBorder:o.changedBorder},"alias-to-value":{label:"Alias → Value",badge:`background:${o.structuralBorder};color:#fff`,rowBg:o.structural,rowBorder:o.structuralBorder},"value-to-alias":{label:"Value → Alias",badge:`background:${o.structuralBorder};color:#fff`,rowBg:o.structural,rowBorder:o.structuralBorder},"group-added":{label:"Group added",badge:`background:${o.addedBorder};color:#fff`,rowBg:o.added,rowBorder:o.addedBorder},"group-removed":{label:"Group removed",badge:`background:${o.removedBorder};color:#fff`,rowBg:o.removed,rowBorder:o.removedBorder}};function M(e){return/^#[0-9a-fA-F]{3,8}$/.test(e.trim())}function S(e,r=!1){if(e===null)return`<span style="color:${o.inkFaint}">—</span>`;const n=r?"text-decoration:line-through;opacity:.55;":"",t=M(e)?`<span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:${e};border:1px solid ${o.chip};vertical-align:middle;margin-right:6px;flex-shrink:0"></span>`:"";return`<span style="display:inline-flex;align-items:center;font-family:'DM Mono',monospace;font-size:.8rem;${n}">${t}${e}</span>`}function z(e){return`<span style="display:inline-block;padding:1px 7px;border-radius:3px;font-size:.68rem;font-family:'Syne',sans-serif;font-weight:700;letter-spacing:.04em;white-space:nowrap;${e.badge}">${e.label}</span>`}function D(e){const r=e.split("."),n=r.slice(-2).join("."),t=r.slice(0,-2).join(".");return t?`<span style="color:${o.inkFaint};font-size:.75rem">${t}.</span><strong>${n}</strong>`:`<strong>${n}</strong>`}function R(e){const r=N[e.kind];if(e.kind==="group-added"||e.kind==="group-removed")return`
    ...
    <tr style="background:${r.rowBg};border-left:3px solid ${r.rowBorder}">
      ...
      <td style="padding:8px 12px">${S(t,e.kind==="removed")}</td>
      <td style="padding:8px 12px">${S(a,!1)}</td>
      <td style="padding:8px 12px">${z(r)}</td>
    ...
    </details>`}function T(e){const r={};for(const a of e)r[a.kind]=(r[a.kind]??0)+1;const n=[],t=["added","removed","changed-value","changed-alias","alias-to-value","value-to-alias","group-added","group-removed"];for(const a of t){const l=r[a];if(!l)continue;const i=N[a];n.push(`<span style="display:inline-flex;align-items:center;gap:5px;padding:4px 10px;border-radius:4px;${i.badge};font-size:.75rem;font-family:'DM Mono',monospace">
...
<link href="https://fonts.googleapis.com/css2?family=Syne:wght@400;700;800&family=DM+Mono:ital,wght@0,400;0,500;1,400&display=swap" rel="stylesheet">`;function w(e,r={}){const{baselineLabel:n="baseline",currentLabel:t="current"}=r,l=[...L(e).entries()].map(([$,g])=>F($,g)).join(""),i=e.length===0;return`
${E}
<div style="
  background:${o.paper};
  color:${o.ink};
...
">
...
</div>`,f={name:"Live Diff (fetched)",render:A(async()=>{const[e,r]=await Promise.all([fetch("./normalized/baseline.json"),fetch("./normalized/current.json")]);if(e.status===404||r.status===404)return G;if(!e.ok)throw new Error(`baseline.json: ${e.status} ${e.statusText}`);if(!r.ok)throw new Error(`current.json: ${r.status} ${r.statusText}`);const n=await e.json(),t=await r.json(),a=x(n,t);return w(a,{baselineLabel:"baseline.json",currentLabel:"current.json"})})};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  ...
  render: asyncStory(async () => {
    const [baseRes, currRes] = await Promise.all([fetch("./normalized/baseline.json"), fetch("./normalized/current.json")]);
