import{l as i}from"./load-tokens-BPyqOTXw.js";const S={title:"Tokens/Color/Primitives"};function l(r){return()=>{const e=document.createElement("div");return e.style.cssText="min-height:200px;background:#f5f2eb;",e.innerHTML=`
      ...
      <tbody>
        ${r.map(e=>`
          <tr>
            ...
            <td class="td-hex">${e.value.slice(0,7).toUpperCase()}</td>
          </tr>
        `).join("")}
      </tbody>
    </table>
