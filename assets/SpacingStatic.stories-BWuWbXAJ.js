import{t as e}from"./chunk-BvrOYcoh.js";async function t(){return[{path:`spacing.space.xs`,name:`spacingSpaceXs`,value:0,unit:`pt`,swiftDeclaration:`public static let spacingSpaceXs = CGFloat(0)`},{path:`spacing.space.sm`,name:`spacingSpaceSm`,value:.20000000298023224,unit:`pt`,swiftDeclaration:`public static let spacingSpaceSm = CGFloat(0.20000000298023224)`},{path:`spacing.space.md`,name:`spacingSpaceMd`,value:.4000000059604645,unit:`pt`,swiftDeclaration:`public static let spacingSpaceMd = CGFloat(0.4000000059604645)`},{path:`spacing.space.lg`,name:`spacingSpaceLg`,value:.800000011920929,unit:`pt`,swiftDeclaration:`public static let spacingSpaceLg = CGFloat(0.800000011920929)`},{path:`spacing.space.xl`,name:`spacingSpaceXl`,value:1.600000023841858,unit:`pt`,swiftDeclaration:`public static let spacingSpaceXl = CGFloat(1.600000023841858)`}]}function n(e){return()=>{let t=document.createElement(`div`);return t.style.cssText=`min-height:200px;background:#f5f2eb;`,t.innerHTML=`
  ...
  `}function a(e){let t=Math.max(...e.map(e=>e.value),1);return`
    <div class="static-grid">
      ...
      <div class="srow-decl" title="${e.swiftDeclaration}">${e.swiftDeclaration}</div>
      <div class="srow-kind"><span class="srow-badge swift">${e.value}${e.unit}</span></div>
    `).join(``)}
    </div>
  `}var o,s,c,l,u;e((()=>{o={title:`Tokens/Spacing/Native (iOS)`},s=`
...
`,c={name:`Space Group Static`,render:n(async()=>{let e=await t();return`
      <style>${s}</style>
      <div class="page">
        ${r(`Cedar Native`,`Spacing`,`Space`,`Static`)}
        ...
        ${i(`Static Core Dimensions`,`CdrSpacing Properties`,e.length)}
        ${a(e)}
      </div>
    `})},l={name:`CdrSpacing.swift File Preview`,render:n(async()=>{let e=await t(),n=`// Automatically generated by Cedar Token Pipeline Pipeline Spike Core
import UIKit
import Foundation

public struct CdrSpacing {
${e.map(e=>`    ${e.swiftDeclaration}`).join(`
`)}
}`;return`
      <style>${s}</style>
      <div class="page">
        ${r(`Cedar Native`,`Spacing`,`File Definition`)}
        <div class="page-title-row">
          <div>
        ...
        ${i(`Swift Output Structures`,`Compiled Output Definitions`,e.length)}
        <pre class="swift-code-block"><code>${n.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}</code></pre>
      </div>
  ...
  render: asyncStory(async () => {
    const tokens = await loadStaticSpacingTokens();
    const swiftLines = tokens.map(t => \`    \${t.swiftDeclaration}\`).join("\\n");
...
}`,...l.parameters?.docs?.source}}},u=[`SpacingSpaceGroup`,`SwiftFileCompilation`]}))();export{c as SpacingSpaceGroup,l as SwiftFileCompilation,u as __namedExportsOrder,o as default};