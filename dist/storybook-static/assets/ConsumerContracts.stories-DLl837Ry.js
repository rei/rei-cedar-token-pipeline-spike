      ...
      <div style="padding:40px 32px;font-family:'DM Mono',monospace;font-size:0.85rem;color:#736e65">
        Loading contract reference…
          ...
          <div style="padding:40px 32px;font-family:'DM Mono',monospace;font-size:0.85rem;color:#be342d">
            Error loading contract reference: ${e instanceof Error?e.message:String(e)}
  ...
  "color-text-link": {
    ...
    usage: "Use for hyperlinks and inline anchors.",
          ...
          <article class="card">
            ...
            <div class="docs-list">
              ${l.map(([e,t])=>{let r=t.summary?n(t.summary):`No summary`,i=t.usage?`<div class=\"usage\">usage: ${n(t.usage)}</div>`:``;return`
                    <div class="docs-item">
        ...
        <div class="grid" style="margin-top:1rem;">
          <article class="card">
            ...
            <pre>${n(JSON.stringify(c,null,2))}</pre>
          </article>
          ...
          <article class="card">
            ...
            <pre>${n(JSON.stringify(a,null,2))}</pre>
          </article>
        </div>
